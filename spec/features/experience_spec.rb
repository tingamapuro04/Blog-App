...
RSpec.describe 'User index and show pages', type: :feature do
  before(:all) do
    @me = User.create(name: 'murife',
                      photo: 'https://www.andbeyond.com
                      wp-content/uploads/sites/5/giraffe-and
                      -sky-line-nairobi.jpg', bio: 'Murife don\'t run', id: 1)
    ...
    @you = User.create(
      ...
      photo: 'https://encrypted-tbn0.gstatic.com/images?
                      q=tbn:ANd9GcTn1lEs_
                      QwtQAHvtgmrPvVAb04SZF78jqQ9GRms2UYqmHIhXuz72OimxgN58_
                      dHKQhaD0o&usqp=CAU',
      bio: 'Mimi ni wafula', id: 2
    )
